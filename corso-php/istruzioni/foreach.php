...
<body>
    ...
    $arr = array(1, 2, 3, 4);
    foreach ($arr as $value) { //se indico solo una variabile dopo as mi trova i valori (senza indici)
        // decido io di chiamare i contenuti di $arr => $value
    ...
    foreach ($a as $chiave => $valore) { //se metto due variabili dopo as scorro l'array trovando chiavi e valori
        // la variabile $valore viene inizializzata automaticamente 
    ...
    if ($a['materia'] == "database") {
        $a['prof'] = "Rossi"; //in questo caso aggiungo Rossi come nuovo valore al mio array
    } else {
        $a['prof'] = "Casadei"; //altrimenti aggiungo Casadei come nuovo valore al mio array
    }
    ...
    relative alle posizioni in cui è memorizzato il valore 10 ($val), 
