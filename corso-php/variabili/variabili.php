...
<body>
  ...
  echo "<hr>"; /*horizontal row per separare i contenuti della pagina*/
  /*PER CASA
  scrivere in una sola echo:
  L'insegnante dice: "è ora di andare a casa!" 
  dove "andare a casa" è una variabile stringa*/
  $casa = "andare " . " a " . "casa!"; /*posso anche concatenare stringhe di una variante, 
         ricorda gli spazi tra virgolette, se ne lasci due adiacenti ne verrà fuori solo uno sul browser, 
         ma lato html con ispeziona verrà fuori due spazi, bisogna sempre ricordare il browser come visualizzerà i simboli speciali*/
  echo "1) L'insegnante dice: \"è ora di $casa\"";
  echo "<br>";
  echo "2) L'insegnante dice: \"è ora di " . $casa . "\""; /*posso fare anche così*/
  echo "<br>";
  echo '3) L\'insegnante dice: "è ora di ' . $casa . '"'; /*stessa cosa ma con l'apice*/
  ?>
